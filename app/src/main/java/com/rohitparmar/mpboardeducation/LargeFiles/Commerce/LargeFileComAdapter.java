...
class LargeFileComAdapter extends RecyclerView.Adapter<LargeFileComAdapter.LargeFileComViewHolder> {
    private InterstitialAd mInterstitialAd;
    private Context context;
    private List<impBookDataModels> list;

    public LargeFileComAdapter(Context context, List<impBookDataModels> list) {
    ...
    @NonNull
    @Override
    public LargeFileComViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new LargeFileComAdapter.LargeFileComViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LargeFileComAdapter.LargeFileComViewHolder holder, int position) {
    ...
    public class LargeFileComViewHolder extends RecyclerView.ViewHolder {
        private TextView bioName ;
        public LargeFileComViewHolder(@NonNull View itemView) {
            super(itemView);
