...
class LargeFileAdapter extends RecyclerView.Adapter<LargeFileAdapter.LargeFileViewHolder> {
    private InterstitialAd mInterstitialAd;
    private Context context;
    private List<impBookDataModels> list;

    public LargeFileAdapter(Context context, List<impBookDataModels> list) {
    ...
    @NonNull
    @Override
    public LargeFileViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LargeFileViewHolder holder, int position) {
    ...
    public class LargeFileViewHolder extends RecyclerView.ViewHolder {
        ...
        public LargeFileViewHolder(@NonNull View itemView) {
            super(itemView);
