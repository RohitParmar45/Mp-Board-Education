...
public class FaqAnswer3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faq_answer3);
        getSupportActionBar().hide();
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);

        faqsection = findViewById(R.id.faqsection3);
        txtFaqAnsewers = findViewById(R.id.txtFaqAnsewers3);
        ...
        database.collection("Faq").document("a3").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
