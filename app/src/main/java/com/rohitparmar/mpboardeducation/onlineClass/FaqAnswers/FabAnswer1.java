...
public class FabAnswer1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fab_answers);

        getSupportActionBar().hide();
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);

        faqsection = findViewById(R.id.faqsection1);
        txtFaqAnsewers = findViewById(R.id.txtFaqAnsewers1);
        ...
        database.collection("Faq").document("a1").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
