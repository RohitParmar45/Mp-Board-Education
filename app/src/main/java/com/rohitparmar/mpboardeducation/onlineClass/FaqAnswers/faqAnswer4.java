...
public class faqAnswer4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faq_answer4);
        getSupportActionBar().hide();
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);

        faqsection = findViewById(R.id.faqsection4);
        txtFaqAnsewers = findViewById(R.id.txtFaqAnsewers4);
        ...
        database.collection("Faq").document("a4").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
