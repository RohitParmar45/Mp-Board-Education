...
public class Rasayan extends AppCompatActivity {
    ...
    private RasayanAdapter adapters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinKitView = findViewById(R.id.spin_kitras);
        spinKitView.setVisibility(View.VISIBLE);


        notesbookRecycler = findViewById(R.id.rasRecycler);

        reference = FirebaseDatabase.getInstance().getReference().child("Rasayanpdf");
        getData();
    ...
    private void getData() {
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                adapters = new RasayanAdapter(Rasayan.this, list);
                notesbookRecycler.setLayoutManager(new LinearLayoutManager(Rasayan.this));
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Rasayan.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                spinKitView.setVisibility(View.GONE);
            }
        });
