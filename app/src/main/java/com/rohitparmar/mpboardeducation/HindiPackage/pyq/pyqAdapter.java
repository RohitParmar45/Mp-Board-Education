...
class pyqAdapter extends RecyclerView.Adapter<pyqAdapter.pyqviewHolder> {

    private Context context;
    private List<impBookDataModels> list;

    public pyqAdapter(Context context, List<impBookDataModels> list) {
